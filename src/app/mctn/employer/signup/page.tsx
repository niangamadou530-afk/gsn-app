...
export default function MctnEmployerSignupPage() {
      ...
      <div className="w-full max-w-md space-y-8">
        <header className="flex flex-col items-center space-y-3 text-center">
          <div className="w-16 h-16 bg-[#0a1628] rounded-2xl flex items-center justify-center shadow-lg">
            <span className="material-symbols-outlined text-white text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>add_business</span>
          </div>
          <h1 className="text-3xl font-extrabold tracking-tight text-on-surface">Espace Entreprises PFIMN</h1>
          <p className="text-on-surface-variant text-sm">Recrutez les talents certifiés NDT — New Deal Technologique</p>
        </header>
        ...
        <p className="text-center text-sm text-on-surface-variant">
          Déjà un compte ?{" "}
          <Link href="/mctn/employer/login" className="text-primary font-bold hover:underline">Se connecter</Link>
        </p>
      </div>
    </main>
  );
