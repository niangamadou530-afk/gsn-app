...
export default function MctnTestPage() {
  ...
  if (blocked) return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      <div className="bg-surface-container-lowest rounded-3xl p-8 max-w-sm w-full text-center shadow-xl">
        ...
        <Link href={`/mctn/learn/${courseId}`} className="block w-full py-3.5 bg-primary text-on-primary font-bold rounded-xl text-center shadow-lg shadow-primary/20 active:scale-95 transition-all">
          Retourner au cours
        </Link>
      </div>
    </div>
  ...
  if (error) return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      <div className="text-center space-y-4">
        ...
        <Link href={`/mctn/learn/${courseId}`} className="text-primary font-bold hover:underline">← Retour au parcours</Link>
      </div>
    </div>
  );
  ...
  return (
    <main className="min-h-screen bg-surface text-on-surface pb-24">
      ...
      {/* Top bar */}
      <header className="fixed top-0 w-full z-50 bg-[#0a1628]/95 backdrop-blur-md flex justify-between items-center px-6 py-4 shadow-md">
        ...
        <span className="text-base font-bold text-white">Test Final PFIMN</span>
        <span className="text-sm font-bold text-white/60">{answeredCount}/{questions.length}</span>
      </header>
      ...
      <div className="pt-24 px-6 max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-xs text-on-surface-variant mt-1.5">Score minimum 70% · Skill Passport PFIMN</p>
        </div>
        ...
        {submitted && (
          <div className="space-y-6 mb-8">
            ...
            {/* Score card */}
            <div className="bg-gradient-to-br from-[#0a1628] to-[#0d2050] rounded-3xl p-8 text-center text-white shadow-xl">
            ...
            <div className="space-y-3">
              {(score >= 70 || course?.certificate_id) && (
                <Link href={`/mctn/learn/${courseId}/certificate`}
