...
export default function MctnPayPage() {
    ...
    <main className="min-h-screen bg-surface text-on-surface pb-32">
      ...
      <header className="fixed top-0 w-full z-50 bg-[#0a1628]/95 backdrop-blur-md flex items-center justify-between px-6 py-4 shadow-md">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-white/60 uppercase tracking-wider">PFIMN · PAY</span>
        </div>
        <button
      ...
      <div className="pt-24 px-6 max-w-2xl mx-auto space-y-8">
        ...
        {/* Hero wallet card */}
        <section className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#0a1628] to-[#0d2050] p-8 shadow-lg">
          <div className="absolute -right-12 -top-12 w-48 h-48 bg-white/10 rounded-full blur-3xl" />
          <div className="absolute -left-12 -bottom-12 w-48 h-48 bg-primary/20 rounded-full blur-3xl" />
          <div className="relative z-10 flex flex-col items-center text-center">
            <span className="text-white/60 text-sm font-medium tracking-wider uppercase mb-2">Solde GSN PAY</span>
        ...
        <section className="bg-surface-container-low p-6 rounded-xl space-y-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-on-surface">Micro-crédit NDT</h3>
                {score >= 50 ? (
          ...
          <p className="text-on-surface-variant text-sm leading-relaxed">
            Boostez votre insertion professionnelle avec nos solutions de financement PFIMN basées sur votre Skill Passport.
          </p>
        </section>
      ...
      <nav className="fixed bottom-0 left-0 w-full z-50 glass-nav rounded-t-3xl shadow-[0_-4px_24px_rgba(25,28,35,0.06)] flex justify-around items-center px-4 pb-6 pt-3">
        ...
        <Link href="/mctn/passport" className="flex flex-col items-center text-outline active:scale-90 transition-transform">
        ...
        <Link href="/mctn/pay" className="flex flex-col items-center text-primary relative after:content-[''] after:absolute after:-bottom-1 after:w-1 after:h-1 after:bg-primary after:rounded-full">
