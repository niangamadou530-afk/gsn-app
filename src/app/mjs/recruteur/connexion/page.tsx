...
export default function ConnexionRecruteurPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!recruteur) {
      setError("Ce compte n'est pas enregistré comme recruteur.");
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-16 max-w-md mx-auto w-full">
        ...
        <div className="mb-8 mt-3">
          ...
          <h1 className="text-[2rem] font-extrabold tracking-tight text-on-background leading-tight mb-2">
            Connexion <span className="text-primary">recruteur</span>
          </h1>
          <p className="text-on-surface-variant leading-relaxed">
            Accède aux profils certifiés PNACIJ.
          </p>
        </div>
        ...
        <p className="text-center text-on-surface-variant text-sm mt-6">
          ...
          <button onClick={() => router.push("/mjs/recruteur/inscription")} className="text-primary font-bold">
            Inscris-toi
          </button>
        </p>
