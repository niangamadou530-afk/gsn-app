  ...
  return (
    <main className="min-h-screen bg-surface text-on-surface flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-16 max-w-md mx-auto w-full">
        ...
        {/* Branding */}
        <div className="mb-10">
          <img src="/images/gsn-logo-transparent.png" alt="GSN Global Skills Network" style={{width:"140px", height:"auto", background:"transparent", mixBlendMode:"multiply"}} className="mb-6" />
